...
def task_plot_logit_fit_for_agreement_symno(
        depends_on = BLD / "data" / "merged_data_full_excluded.csv",
        produces = OVERLEAF_FIGURES / "figures/autom_figures/agreement_frontier_symno.pdf"
):
    df = pd.read_csv(depends_on)
